...
from mfem.ser import getEulerSystem, RusanovFlux
...
def run(problem=1,
    ...
    euler = getEulerSystem(vfes, numericalFlux, specific_heat_ratio, gas_constant, IntOrderOffset)
